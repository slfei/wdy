    ...
    <div class="g-core-image-corp-container" v-bind:id="'vciu-modal-' + formID" v-show="hasImage">
      ...
      <div class="info-aside">
        <p class="btn-groups rotate-groups" v-if="crop">
          <button type="button" v-on:click="doRotate" class="btn btn-rotate"><i class="ion-android-refresh"></i></button>
          <button type="button" v-on:click="doReverseRotate" class="btn btn-reverserotate"><i class="ion-android-refresh"></i></button>
        </p>
