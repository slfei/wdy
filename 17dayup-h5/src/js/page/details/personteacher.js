...
function fnAjax(_this,index){
    var url = ['/api/institute/teachercourse?teacher_id='+ id +'&is_html=1&page_num='+ page_num_o,'/api/institute/teachercomment?teacher_id=' + id +'&is_html=1&page_num='+ page_num_t+'&rank='+ rank];
    if(url[index]){
        $.ajax({
            url: url[index],
            type: 'GET',
